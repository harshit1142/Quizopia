        ...
        <div class="page-content">
            <div class="sidebar">
                ...
                <div class="option-bar">
                    ...
                    <a  class="icon-link">
                        <div  onClick={()=>setCurr("ques")} class="option-iconbox">
                            <span class="icon"><i class='fa fa-question'></i></span>
                            <div class="options">Questions</div>
                        </div>
                    </a>
                </div>
            </div>
            { curr==="dash"?
              <section class="main-content">
                <div class="card-box">
                    <a href="" class="cards cards-teacherdashboard">
                    ...
                    <a href="" class="cards cards-teacherdashboard">
                        <div class="btn-content">Total Question <span class="icon"><i class='fa fa-question'></i></span>
                        </div>
                    </a>
                </div>
            </section>:
             ...
             <section class="main-content">
                <div class="card-box">
                    <a href="" class="cards cards-teacherexam">
            ...
            :<section class="main-content">
                <div class="card-box">
                    <a  class="cards cards-teacherquestion">
                        <div class="btn-content">Add Question <span class="icon"><i class='fa fa-plus'></i></span>
                        </div>
                    </a>
                    <a href="" class="cards cards-teacherquestion">
                        <div class="btn-content">View Question <span class="icon"><i class='fa fa-eye'></i></span>
                        </div>
                    </a>
                </div>
            </section>}
